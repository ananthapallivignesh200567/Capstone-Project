...
export const AdditionalForm: React.FC<AdditionalFormProps> = ({ data, onChange }) => {
  ...
  return (
    <div className="space-y-6">
      <p className="font-mono text-xs text-[#0e7490] border-l-2 border-[#0e7490] pl-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          <Textarea
            ...
            className="min-h-[120px] text-black rounded-none border-black bg-white focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-[#0e7490]"
          />
        </div>
        <div className="space-y-2">
          <Label
